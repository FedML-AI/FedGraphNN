        ...
        for epoch in range(args.epochs):
            ...
            for idx_batch, batch in enumerate(train_data):
                ...
                neg_edge_index = negative_sampling(
                    edge_index=batch.train_pos_edge_index, num_nodes=batch.num_nodes,
                ...
                z = model.encode(batch.x, batch.train_pos_edge_index); self.train_z = z.item()
                link_logits = model.decode(z, batch.train_pos_edge_index, neg_edge_index)
                link_labels = self.get_link_labels(batch.train_pos_edge_index, neg_edge_index, device)
