...
from training.ego_networks.federated_nc_trainer import FederatedNodeClfTrainer
...
def create_model(args, model_name, feat_dim, num_cats, output_dim):
    ...
    if model_name == 'gcn':
        ...
        trainer = FederatedNodeClfTrainer(model)
    else:
...
#     # customize the process name
    ...
    for batch in enumerate(data_local_num_dict[0]):
        print(batch)
