...
print(args)
command = "kill $(ps aux | grep main_fedavg_reg.py | grep -v grep | awk '{{print $2}}')"
print(command)
os.system(command)
                    ...
                    for read_dim in read_dim_hpo:
                        for graph_dim in graph_dim_hpo:
                            for dr in dropout_hpo:
                                ...
                                os.system('nohup sh run_fedavg_distributed_reg.sh 8 8 1 {args.gpu} '
                                          '{args.model_name} '
                                          'hetero '
                                          '{args.alpha} '
                                          '{args.round} '
                                          ...
                                          '{args.dataset} '
                                          '"./../../../data/{args.dataset}/" 0 '
                                          '> ./fedgnn_reg_{args.model_name}_{args.dataset}_{args.run_id}.log 2>&1 &'.format(args=args))
