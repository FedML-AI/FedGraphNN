...
def add_args(parser):
    ...
    parser.add_argument('--dataset', type=str, default='freesolv', help='Dataset used for training')
...
optimal_hyperparam_dict = {'epochs' : -1,
                           'lr' : -1,
                ...
                for read_dim in read_dim_hpo:
                    for graph_dim in graph_dim_hpo:
                        for dr in dropout_hpo:
                            ...
                            wandb.init(project="fedmolecule",name="FedMolecule(d)" + str(args.lr) + "_" + args.model + "_" + args.dataset,config=args)
                            ...
                            if test_score < min_test_score:
                                ...
                                optimal_hyperparam_dict['graph_embedding_dim'] = graph_dim
