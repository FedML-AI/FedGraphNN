...
def add_args(parser):
    ...
    parser.add_argument('--dataset', type=str, default='esol', help='Dataset used for training')
    ...
    parser.add_argument('--metric', type=str, default='rmse', help='Metric to be used to evaluate classification models')
